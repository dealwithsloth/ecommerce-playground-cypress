...
describe('Product page tests', () => {
    beforeEach(() => {
        ...
        singleRegister.breadCrumbs.should('be.visible').and('contain.text', 'Apple Cinema 30')
    })

    it('Configurable product stock and price', () => {
        productPage.availabilityBadgeInStock.should('be.visible')
        productPage.price.should('be.visible').and('contain.text', '$100.00')
        ...
        productPage.price.should('be.visible').and('contain.text', '$117.00')
        productPage.productVariantSelect.should('be.visible')
        productPage.productVariantSelect.select(2).should('contain.text', 'Medium')
        productPage.price.should('be.visible').and('contain.text', '$76.00')
        productPage.productVariantSelect.should('be.visible')
        productPage.productVariantSelect.select(3).should('contain.text', 'Large')
        productPage.price.should('be.visible').and('contain.text', '$115.00')
    })
    ...
    it('Description, Reviews, Custom', () => {
        ...
        productPage.descriptionTabContent.should('be.visible').and('contain.text', "The 30-inch Apple Cinema HD Display delivers")
